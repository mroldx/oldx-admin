...
import com.oldx.web.exception.ValidateCodeException;
...
public class ImageCodeFilter extends OncePerRequestFilter implements InitializingBean {
    ...
    private void validateCode(ServletWebRequest servletWebRequest) throws ServletRequestBindingException {
        ImageCode codeInSession = (ImageCode) sessionStrategy.getAttribute(servletWebRequest, MoliConstant.SESSION_KEY_IMAGE_CODE);
        ...
        if (codeInSession.isExpire()) {
            sessionStrategy.removeAttribute(servletWebRequest, MoliConstant.SESSION_KEY_IMAGE_CODE);
